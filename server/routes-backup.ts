...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Note: Chat API route moved to modular router (routes/chat.ts) for better organization
  ...
  // Use modular routes  
  app.use('/api/chat', chatRouter); // Chat now works without authentication for local storage
