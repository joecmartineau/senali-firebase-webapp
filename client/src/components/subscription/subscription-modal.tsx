  ...
  const handleSubscribe = async (planType: 'trial' | 'monthly' | 'yearly') => {
    ...
    try {
      if (planType === 'trial') {
        ...
        alert(`📱 In the mobile app, this would open ${planType === 'monthly' ? 'monthly ($9.99)' : 'yearly ($79.99)'} subscription purchase through your device's app store.`);
            ...
            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
              ...
              <CardFooter className="flex flex-col gap-2">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">/year (33% off)</span>
                </div>
              </CardFooter>
            </Card>
          </div>
